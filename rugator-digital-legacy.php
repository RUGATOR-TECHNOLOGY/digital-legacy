 ...
 * Description: (Plugin en Desarrollo) Schedules the deletion of user accounts after a period of inactivity and allows users to set their preferences. [rugator_digital_legacy]
 * Version: 0.0.1
